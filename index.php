...
<html>
    ...
    <fieldset>
        <ul>
            <li>
                ...
                <input id="email" name="email" value="test_user_338093@testuser.com" type="email" placeholder="your email"/>
            </li>
            <li>
  ...
  <script type="text/javascript">
    Mercadopago.setPublishableKey("TEST-bec6ed25-9045-4969-b48d-f229acc73315");
